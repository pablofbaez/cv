...
::: aside
```{r}
print_text_block('research_positions_aside')
```
:::
...
```{r}
print_section('research_collaborations')
```
...
```{r}
print_section('trainings_attended')
```
...
```{r}
print_section('professional_positions')
```
...
::: aside
```{r}
print_text_block('academic_articles_aside')
```
:::
